...
public class HomeActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Todo List App");
...
//
    ...
    private void addTask() {
        ...
        final EditText description = myView.findViewById(R.id.discription);
        Button save = myView.findViewById(R.id.saveBtn);
        Button cancel = myView.findViewById(R.id.cacnelBtn);
